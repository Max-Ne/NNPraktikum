...
def main():
    ...
    # Stupid Classifier
    #myStupidClassifier = StupidRecognizer(data.training_set,data.validation_set,data.test_set)
    ...
    # Perceptron
    #myPerceptronClassifier = Perceptron(data.training_set,data.validation_set, data.test_set,learning_rate=0.005,                   epochs=10)
    ...
    # Logistic Regression
    #myLRClassifier = LogisticRegression(data.training_set,                                        data.validation_set,data.test_set,learning_rate=0.005,epochs=30)
